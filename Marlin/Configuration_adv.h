...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 2.4    // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       700        // (mA) RMS current. Multiply by 1.414 for peak current. ON 650 there were steps skips 
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  155// at 140 fail 
